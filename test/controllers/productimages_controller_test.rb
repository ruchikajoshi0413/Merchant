...
class ProductimagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create productimage" do
    assert_difference("Productimage.count") do
      post productimages_url, params: { productimage: { image: @productimage.image, product_id: @productimage.product_id } }
    end
  ...
  test "should update productimage" do
    patch productimage_url(@productimage), params: { productimage: { image: @productimage.image, product_id: @productimage.product_id } }
